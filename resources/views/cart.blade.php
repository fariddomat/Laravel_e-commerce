            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="cart">
                        ...
                        <h1 class="cart-title">In Your Shopping Cart: <span
                                class="c-primary">{{Cart::content()->count()}}
                                items</span></h1>
                            ...
                            <tbody>
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-remove">
                                        <a href="{{route('cart.delete',$product->rowId)}}" class="product-del remove"
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="#">
                                                <img style="max-width: 70px;border-radius: 15px;"
                                                    src="{{ asset($product->model->image_path) }}" alt="product"
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            <a href="{{route('cart.decr',[$product->rowId,$product->qty])}}" class="quantity-minus">-</a>
                                            <input name="qty" title="Qty" value="{{$product->qty}}"
                                                class="email input-text qty text" type="text" placeholder="1" readonly>
                                        <a href="{{route('cart.incr',[$product->rowId,$product->qty])}}" class="quantity-plus">+</a>
                                        </div>
